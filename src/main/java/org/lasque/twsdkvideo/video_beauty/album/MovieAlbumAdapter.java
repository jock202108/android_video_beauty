...
public class MovieAlbumAdapter extends RecyclerView.Adapter<MovieAlbumAdapter.ViewHolder>
{
    ...
    {   //lsq_album_select_video_item
        return new ViewHolder(mInflater.inflate(R.layout.lsq_new_album_select_video_item,parent,false));
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position)
    {
        ...
        TuSdkSize tuSdkSize =  TuSdkContext.getScreenSize();
        if(tuSdkSize != null){
            layoutParams.width = (tuSdkSize.width - TuSdkContext.dip2px(4)) / 3;
            layoutParams.height = (tuSdkSize.width - TuSdkContext.dip2px(4)) / 3;
        }else {
            layoutParams.width = (VideoBeautyPlugin.screenWidth - TuSdkContext.dip2px(4)) / 3;
            layoutParams.height = (VideoBeautyPlugin.screenWidth - TuSdkContext.dip2px(4)) / 3;
        }
