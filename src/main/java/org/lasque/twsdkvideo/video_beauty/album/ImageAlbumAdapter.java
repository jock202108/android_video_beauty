...
public class ImageAlbumAdapter extends RecyclerView.Adapter<ImageAlbumAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position)
    {
        ...
        layoutParams.width = (TuSdkContext.getScreenSize().width - TuSdkContext.dip2px(4)) / 3;
        layoutParams.height = (TuSdkContext.getScreenSize().width - TuSdkContext.dip2px(4)) / 3;
