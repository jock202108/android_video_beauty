...
import org.lasque.twsdkvideo.video_beauty.views.FilterConfigView;
...
//                getEditorController().getPlayBtn().setVisibility(View.VISIBLE);
    ...
    public EditorFilterComponent setHeadAction() {

        getEditorController().getActivity().getTitleView().findViewById(R.id.lsq_back1).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        getEditorController().getActivity().getTitleView().findViewById(R.id.lsq_save).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mSelectEffectData != null) {
...
//            = bottomView.findViewById(R.id.lsq_filter_close);

            //点击空白处保存状态
           View video_view =  bottomView.findViewById(R.id.video_view);
