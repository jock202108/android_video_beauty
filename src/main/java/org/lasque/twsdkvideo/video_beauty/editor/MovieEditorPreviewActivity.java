...
import org.lasque.twsdkvideo.video_beauty.views.TuSDKMediaPlayer;
...
public class MovieEditorPreviewActivity extends ScreenAdapterActivity{
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == R.id.lsq_back) {//返回按钮
                onBack();
            } else if (id == R.id.lsq_next) {//下一步
...
//                        Intent intent = new Intent(MovieEditorPreviewActivity.this,MovieEditorCutActivity.class);
...
//                        startActivity(intent);
            ...
            } else if (id == R.id.lsq_media_player) {
