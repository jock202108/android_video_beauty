 ...
 * @author		Yanlin
 * @Date		7:19:13 PM
 * @Copright	(c) 2015 tw. All rights reserved.
 *
 */
...
public class SimpleCameraActivity extends ScreenAdapterActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
    {
        ...
        TuMessageHubInterface tuMessageHubInterface =  TuSdk.messageHub();
        if(tuMessageHubInterface != null){
            tuMessageHubInterface  .applyToViewWithNavigationBarHidden(false);
        }
...
//        captureSetting.previewMaxSize = 1280;
        ...
        captureSetting.facing = CameraConfigs.CameraFacing.Back;
...
//         mVideoCamera.setDetectScale(0.1f);
    ...
    protected void onPause()
    {
        ...
        //原有代码是停止，需求需要暂停 再继续stopCameraCapture();
        pauseCameraCapture();
