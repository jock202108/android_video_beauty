...
import org.lasque.twsdkvideo.video_beauty.views.props.model.PropsItemMonster;
...
public class PropsItemMonsterPageFragment extends PropsItemPageFragment {
    ...
    private DataSource<PropsItemMonsterViewHolder,PropsItemMonster> mDataSource = new DataSource<PropsItemMonsterViewHolder,PropsItemMonster>() {
    ...
    public class PropsItemMonsterViewHolder extends PropsItemViewHolder<PropsItemMonster>
    {
        ...
        private void handleClickEvent(int position) {
            ...
            if (getItemDelegate() != null)
                getItemDelegate().didSelectPropsItem(mDataSource.itemData(position),null);
