...
public class TuSdkMovieScrollPlayLineView extends FrameLayout {
    ...
    public void addFirstFrameBitmap(Bitmap bitmap){
        mMoviePlayScrollView.addFirstFrameBitmap(bitmap);
    }
    ...
    public void setCursorMinPercent(float minPercent) {
        mMoviePlayScrollView.setCursorMinPercent(minPercent);
    }

    /** 光标最右边 **/
    public void setCursorMaxPercent(float maxPercent) {
        mMoviePlayScrollView.setCursorMaxPercent(maxPercent);
    }
    ...
    public void setPercent(float percent) {
        mMoviePlayScrollView.setPercent(percent);
    }
    ...
    public void setOnPlayPointerChangeListener(TuSdkMovieScrollContent.OnPlayProgressChangeListener progressChangeListener) {
        ...
        mMoviePlayScrollView.setOnPlayPointerChangeListener(progressChangeListener);
    }

    public void setOutlineType(int outlineType) {
        mMoviePlayScrollView.setOutLineType(outlineType);
    }
}
