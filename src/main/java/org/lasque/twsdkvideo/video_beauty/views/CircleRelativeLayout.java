...
public class CircleRelativeLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        color = array.getColor(R.styleable.CircleRelativeLayoutLayout_background_color_1,0X0000000);
        alpha = array.getInteger(R.styleable.CircleRelativeLayoutLayout_background_alpha_1,255);
        setColors();
        array.recycle();
    }
    @Override
