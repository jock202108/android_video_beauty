package org.lasque.twsdkvideo.video_beauty.views.editor.playview.rangeselect;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (onSelectColorRectListener != null)
                    onSelectColorRectListener.onSelectColorRect(rectView);
                break;
        }
