...
public class FilterFragment extends Fragment {
    ...
    private static final String FILTER_TYPE_ITEM_NAME_LIST = "filterTypeItemNameList";
    private ArrayList filterTypeItemNameList;
    ...
    public static FilterFragment newInstance(FilterGroup group, ArrayList filterTypeItemNameList) {
        FilterFragment fragment = new FilterFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(FILTER_GROUP, group);
        bundle.putParcelableArrayList(FILTER_TYPE_ITEM_NAME_LIST, filterTypeItemNameList);
        fragment.setArguments(bundle);
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            filterTypeItemNameList = (ArrayList) bundle.getSerializable(FILTER_TYPE_ITEM_NAME_LIST);
            getFilterView(view);
        }
        return view;
    }
    ...
    private void getFilterView(View view) {
        ...
        mFilterAdapter = new FilterOptionRecyclerAdapter(new ArrayList<FilterOption>(mFilterGroup.filters), filterTypeItemNameList);
