...
public class SpeedView extends RelativeLayout {
    ...
    private OnClickListener mSpeedBarOnClickListener = new TuSdkViewHelper.OnSafeClickListener() {
        ...
        public void onSafeClick(View v) {
            ...
            ((Button) v).setTextColor(getContext().getResources().getColor(R.color.lsq_color_black));
            v.setBackgroundResource(R.drawable.tusdk_edite_cut_speed_button_bg_new);
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        LayoutParams speedViewWrap = new LayoutParams(context,attrs);
