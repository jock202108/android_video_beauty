...
public class AudioConvert {
    ...
    private LinkedBlockingQueue<AudioItem> mOutputQueue = new LinkedBlockingQueue<>(Integer.MAX_VALUE);

    private LinkedBlockingQueue<AudioItem> mInputQueue = new LinkedBlockingQueue<>(Integer.MAX_VALUE);
