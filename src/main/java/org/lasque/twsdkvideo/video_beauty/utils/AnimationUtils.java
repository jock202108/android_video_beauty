...
public class AnimationUtils {
     ...
     * 弹出照片文件夹列表
     */
    public static void openFolder(View view, int titleHeight) {
        if (view != null) {
            view.setVisibility(View.VISIBLE);
            ObjectAnimator animator = ObjectAnimator.ofFloat(view, "translationY",
                    -view.getHeight() + titleHeight, 0).setDuration(300);
     ...
     * 收起照片文件夹列表
     */
    public static void closeFolder(View view, int titleHeight) {
        if (view != null) {
            ObjectAnimator animator = ObjectAnimator.ofFloat(view, "translationY",
                    0, -view.getHeight() + titleHeight).setDuration(300);
            animator.addListener(new AnimatorListenerAdapter() {
                @Override
