package org.lasque.twsdkvideo.video_beauty.effectcamera;
...
import static org.lasque.twsdkvideo.video_beauty.effectcamera.base.BaseActivity.ALBUM_REQUEST_CODE;
import static org.lasque.twsdkvideo.video_beauty.effectcamera.base.BaseActivity.ALBUM_RESULT_CODE;
...
import org.lasque.twsdkvideo.video_beauty.effectcamera.album.AlbumInfo;
import org.lasque.twsdkvideo.video_beauty.effectcamera.audio.AudioItem;
import org.lasque.twsdkvideo.video_beauty.effectcamera.audio.AudioListActivity;
import org.lasque.twsdkvideo.video_beauty.effectcamera.audio.AudioMixerItem;
import org.lasque.twsdkvideo.video_beauty.effectcamera.audio.AudioRecord;
import org.lasque.twsdkvideo.video_beauty.effectcamera.utils.Constants;
import org.lasque.twsdkvideo.video_beauty.effectcamera.utils.PermissionUtils;
import org.lasque.twsdkvideo.video_beauty.effectcamera.utils.SensorHelper;
...
import org.lasque.twsdkvideo.video_beauty.tubeautysetting.RecordManager;
  ...
  private void initRecordView() {
    ...
    mRecordView.setDelegate(new RecordView.TuSDKMovieRecordDelegate() {
      ...
      public boolean startRecording() {
        ...
        mPipeMediator.startRecord(outputPath, mCurrentRenderSize.width, mCurrentRenderSize.height, null, 1, new RecordManager.RecordListener() {
          @Override
    ...
    mCamera.cameraShot().setShotListener(new TuCameraShot.TuCameraShotListener() {
      ...
      public void onCameraShotBitmap(TuSdkResult data) {
        ...
        try {
          ...
          //  canvas.drawBitmap(null, paddingLeft, paddingTop, null);
